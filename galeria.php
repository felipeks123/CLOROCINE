        ...
        <div class="col s4">
            <div class="card hoverable">
                <div class="card-image">
                    <img src="https://img.itdg.com.br/tdg/images/recipes/000/033/200/166353/166353_original.jpg?mode=crop&width=710&height=400">
                ...
                <div class="card-content">
                    ...
                    <span class="card-title">Torta De Macarrao</span>
...
<br>Queijo ralado para polvilhar</p>
        ...
        <div class="col s4">
            <div class="card hoverable">
                <div class="card-image">
                    <img src="https://img.itdg.com.br/tdg/images/recipes/000/167/055/138677/138677_original.jpg?mode=crop&width=710&height=400">
                    <a class="btn-floating halfway-fab waves-effect waves-light grey"><i class="material-icons">favorite_border</i></a>
                </div>
                <div class="card-content">
                    <p class="valign-wrapper"><i class="material-icons amber-text">star</i>9,1</p>
                    <span class="card-title">Dogão Prensado</span>
                    <p><h5>INGREDIENTES</h5>
...
<div class="col s4">
            <div class="card hoverable">
                <div class="card-image">
                    <img src="https://img.itdg.com.br/tdg/images/recipes/000/021/079/31898/31898_original.jpg?mode=crop&width=710&height=400">
                    <a class="btn-floating halfway-fab waves-effect waves-light grey"><i class="material-icons">favorite_border</i></a>
                </div>
                <div class="card-content">
                    <p class="valign-wrapper"><i class="material-icons amber-text">star</i>9,1</p>
                    <span class="card-title">Torta De Morango</span>
                    <p>INGREDIENTES
                    <h5>MASSA:</h5>
